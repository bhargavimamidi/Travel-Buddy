                ...
                <div class="col-lg-12 login-form">
                    <div class="col-lg-12 login-form">
                        ...
                        <div class="col-lg-6 login-btm login-button" >
                            ...
                            <a href="forgotpassword/forgot.php" class="btn btn-outline-primary">FORGOT PASSWORD</a>
                        </div>
                    </div>
                        <script>  
                            function validation()  
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6">
          ...
          <div class="col-md-3">
            ...
            <div class="contact">
                <li>Contact : 9989024567 </li>
               <li>Mail Us: travelbuddy@gmail.com</li>
            </div>
          </div>
      </div>
      <div class="row">
