...
<body class="form-v10">
	...
	<div class="page-content">
		<div class="form-v10-content">
			<form class="form-detail" action="upload.php" method="post" id="myform">
				...
				<div class="form-right">
					...
					<div class="form-row">
						<input type="text" name="Review" class="additional" id="Review" placeholder="Review" required>
					</div>
					
					<div class="form-row-last">
						<input type="submit" name="share" class="register" value="Share">
					</div>
				</div>
			</form>
		</div>
		...
		<h2 style="margin-left: 200px;">User Reviews</h2>
